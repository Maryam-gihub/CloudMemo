...
const SIdeNavbar = () => {
    ...
    const [box, setBox] = useState([note, remind, trash, archive])
    ...
    return (
        <div className='col-lg-2 col-3 px-lg-5 shadow flex flex-wrap' style={{ height: '89vh'}}>
            <div className='fs-4 gap-3 '>
                ...
                <button className='mt-2 btn  fw-bold fs-lg-5 fs-6 ' onClick={addFolder} ><i className="fa-solid fa-folder-plus me-4"></i> Folder</button>
