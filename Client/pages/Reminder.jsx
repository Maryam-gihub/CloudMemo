        ...
        <div>
            ...
            <div className='d-flex gap-2'>
                ...
                <div className='col-lg-9 col-11 pt-4 mx-auto'>
                    <div className='mx-aut  justify-content-center gap-2 d-flex'>
                        <input type="datetime-local" className='col-lg-6 py-lg-2 px-lg-4 px-3 rounded-3 col-7 border border-dark shadow bg-white text-capitalize fw-bold' placeholder = 'reminder(...time/date)' onChange = {(e)=>setRemind(e.target.value)} value = {remind}/> <br />
                    ...
                    <div id = 'show' style = {{display: 'none'}}>
                        ...
                        {array.map((remind, index)=>(
                            <tr key = {index}>
                                ...
                                <th className = 'text-danger flex-wrap text-capitalize'>{remind}</th>
